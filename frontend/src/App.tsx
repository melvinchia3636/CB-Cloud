      ...
      <div className="pt-12 px-16 w-full flex flex-col overflow-x-hidden flex-shrink-[9999]">
        <div className="flex w-full justify-between">
          ...
          <div className="flex gap-10">
            <button aria-label="search" type="button"><span className="iconify w-6 h-6 text-gray-900" data-icon="uil:settings" /></button>
            <button aria-label="search" type="button"><span className="iconiconify w-6 h-6 text-gray-900" data-icon="uil:sliders-v" /></button>
            <div className="w-12 h-12 rounded-full overflow-hidden shadow-md"><img alt="avatar" src="https://picsum.photos/id/1033/300" /></div>
          </div>
        </div>
        <div className="font-semibold mt-2 flex gap-2 text-lg items-center flex-wrap whitespace-nowrap" id="breadcrumb">
          Cloud
